      ...
      <div className="flex-1 flex items-center justify-center px-6 relative">
        <div className="w-full max-w-sm">
          ...
          <Card variant="elevated" padding="lg">
            <div className="mb-6">
              <h2 className="text-xl font-bold text-text-primary font-display">Acessar sistema</h2>
            ...
            <div className="flex flex-col gap-4">
              ...
              {error && (
                <div className="flex items-center gap-2 bg-danger-light border border-danger/20 rounded-lg px-3 py-2.5 text-sm text-danger" role="alert">
                  <AlertCircle size={14} className="shrink-0" />
                  {error}
                </div>
              )}

              <Button onClick={handleSubmit} loading={loading} fullWidth className="mt-1">
                Entrar
              </Button>
            </div>
          </Card>
