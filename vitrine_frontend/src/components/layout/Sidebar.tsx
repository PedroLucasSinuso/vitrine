...
export default function Sidebar() {
  ...
  return (
    <aside className="hidden lg:flex lg:flex-col fixed left-0 top-0 h-full w-[var(--sidebar-width)] bg-bg-sidebar border-r border-border z-40">
      {/* Logo */}
      <div className="flex items-center px-5 h-[var(--header-height)] border-b border-border shrink-0">
          ...
          return (
            <button
              ...
              className={`w-full flex items-center gap-3 px-3 py-2.5 rounded-lg text-sm font-medium transition-all duration-fast text-left
                ${active
                  ? 'bg-bg-sidebar-item-active text-primary font-semibold'
