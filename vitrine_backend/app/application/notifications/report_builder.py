...
def construir_relatorio_semanal(nome_loja: str, source: TransactionSource) -> str:
    hoje = date.today()
    ...
    dominio = criar_dominio(source, inicio, fim)
    dominio_ant = criar_dominio(source, inicio_ant, fim_ant)
